...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=8080, debug=True, use_reloader=True, ssl_context=('/home/ubuntu/fullchain.pem', '/home/ubuntu/privkey.pem'))  #use_reloader=False para evitar reinicializações duplicadas)
